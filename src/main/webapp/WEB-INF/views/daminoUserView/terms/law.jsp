<%@page import="com.damino.web.user.terms.impl.UserTermsDAOImpl"%>
<%@page import="com.damino.web.user.terms.UserTermsVO"%>
						...
						<article class="terms-wrap">
							...
							<div class="menu-sub-wrap">
								<div class="menu-sub js_tab">
									<ul>
										<li class="active"><a href="#term1">${homepageLaw.subtitle }</a></li>
										<li><a href="#term2">${locationLaw.subtitle }</a></li>
									</ul>
								</div>
							</div>
