...
<link rel="shortcut icon" href="https://newcdn.dominos.co.kr/renewal2018/w/img/favicon.ico"/>
	...
	.pop_toast .pop_wrap {overflow:hidden;position:absolute; top:100px; left:50%; min-width:400px;min-height:70px; margin-left:-200px; padding:20px; background:url(../../../newcdn.dominos.co.kr/renewal2018/w/img/bg/bg_color_navy.png) repeat 0 0;border-radius:12px;}
                    ...
                    <article class="company-area">
                        ...
                        <div class="tab_content_wrap">
                            <div class="tab_content active">
                                <div class="ceo_area">
                                    <div class="ceo_lft">
                                        <strong>고객 여러분 안녕하십니까?<br>한국다미노피자 회장 오광현입니다.</strong>
                                        <p>세계 배달 피자 리더인 한국다미노피자는 배달 피자 개념이 전무했던 1990년에 1호점 오금점 오픈을 시작으로 한국 시장에 진출한 이후 지난 30년간 피자 대중화를 선도하였습니다.</p>
                                        <p>“고객들에게 최고로 맛있고 영양 많은 피자를 제공”한다는 원칙 아래, 최고급 식자재와 크리에이티브한 맛을 선보이며 프리미엄 피자 시장을 개척하였습니다. 또한 업계최초로 국내산 오이로 만든 우리 피클 도입, 흑미와 6가지 슈퍼시드가 함유된 슈퍼시드 도우 등 웰빙 건강 식재료를 출시, 건강한 피자를 만들기 위해 최선을 다했습니다. 또한 “고객들이 편하고 쉽게 주문할 수 있도록 최상의 서비스를 제공”하기 위해 주문 혁신, 배달 혁신에도 최선을 다했습니다. 2010년 업계 최초로 주문형 애플리케이션을 출시하고 주문 채널을 확대, 2015년에는 피자업계 최초로 고객 맞춤형 DIY 주문 서비스인 “마이키친(My Kitchen)”애플리케이션, 2016년에는 음성인식 주문 서비스 SKT 누구(NUGU)도입, 2017년에는 업계 최초로 인공지능(A.I) 채팅 주문서비스 “도미챗(Domichat)”을 런칭하였습니다.</p>
                                      <p>2018년에는 배달업계 최초로 “GPS 트래커”를 선보이며 안심, 안전 배달을 위해 앞장서고 있으며 야외에서도 피자 시식이 가능하도록 “다미노 스팟” 런칭, 현재 전국 1,000개 지역에서 서비스를 실시하였습니다.</p>
                                        <p>2019년 다미노피자는 완벽한 조리법과 배달 서비스를 통해 남녀노소 모두가 일상 속에서 즐길 수 있는 가장 완벽한 한 끼로 Life food를 만들어 나아가겠다는 의지를 반영한 새로운 브랜드 슬로건 'Life Food, Domino's.'(라이프 푸드, 다미노)를 발표했습니다. 또한 차량 이용 매장 방문 포장 시 고객의 차량까지 매장 직원이 직접 피자를 전달하는 `다미노 드라이빙 픽업 서비스`와 알림벨 서비스등 혁식적인 IT 서비를 런칭하였으며, 업계최초로 방문포장 보증제도를 도입하여 고객 만족도를 더욱 높였습니다.</p>
                                        <p>이러한 성과를 인정받아, &lt;고객이 가장 추천하는 기업(KNPS) 7년 연속 1위 수상&gt;, &lt;한국 산업의 고객 만족도(KCSI)피자부문 1위 5년 연속 수상&gt;, &lt; Korean Standard 프리미엄 브랜드 지수 4년 연속 1위&gt; &lt;앱어워드 코리아 2019 올해의 앱&gt;, &lt;대학생이 뽑은 올해의 핫 브랜드&gt; 수상으로 2019년 관왕을 달성하는 쾌거를 거두었습니다.</p>
                                    </div>
                                    <div class="ceo_rgt">
                                      <p>앞으로도 한국다미노피자는 세계 배달피자 리더로써 건강한 외식문화를 리드하기 위해 최상의 식재료, 제품, 주문 및 배달 서비스를 제공하며, 언제나 고객들이 믿고 먹을 수 있는 웰빙 먹거리 문화를 만들 수 있도록 최선을 다할 것입니다.</p>
                                      <p>고객 여러분의 많은 사랑과 관심 부탁 드립니다.<br>감사합니다.</p>
                                        <div class="txt_sign">
                                            <span>한국다미노피자 회장 오광현</span>
                                            <img src="../../../newcdn.dominos.co.kr/renewal2018/w/img/img_ceo_sign.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
	...
	<footer id="footer">
		...
		<div class="awards-area">
			<div class="inner-box">
				<ul>
					<li>
						<img src="../../../newcdn.dominos.co.kr/domino/pc/images/list_awards.png" alt="">
						<p>식품안전<br>경영시스템 인증</p>
					</li>
					<li>
						<img src="../../../newcdn.dominos.co.kr/domino/pc/images/list_awards2.png" alt="">
						<p>지식경제부<br>우수디자인 선정</p>
					</li>
					<li>
						<img src="../../../newcdn.dominos.co.kr/domino/pc/images/list_awards3.png" alt="">
						<p>고객이 가장 추천하는 기업<br>피자전문점 부문 7년 연속 1위</p>
					</li>
					<li>
						<img src="../../../newcdn.dominos.co.kr/domino/pc/images/list_awards4.png" alt="">
						<p>2019년 한국산업 고객만족도<br>피자전문점 부문 5년 연속 1위</p>
					</li>
					<li>
						<img src="../../../newcdn.dominos.co.kr/domino/pc/images/list_awards5.png" alt="">
						<p>2019 프리미엄브랜드지수<br>피자전문점 부문 4년 연속 1위 수상</p>
					</li>
					<li>
						<img src="../../../newcdn.dominos.co.kr/domino/pc/images/list_awards6.png" alt="">
