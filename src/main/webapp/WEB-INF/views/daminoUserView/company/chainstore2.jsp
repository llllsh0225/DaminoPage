						...
						<article class="company-area">
							...
							<div class="tab-type4 col5">
								<ul class="btn_tab">
									...
									<li class="active"><a href="chainstore2.html">개설 절차</a></li>
								...
								<div class="tab_content active">
									...
									<div class="franchisee_area">
										...
										<div class="fran_section">
											<strong class="tit_fran">다미노피자의 주인이 되어보세요!</strong>
											<ol class="lst_fran_step">
												<li>
													<dl>
														<dt>Step.1 가맹 상담</dt>
														<dd>
												...
												<li>
													<dl>
														<dt>Step.2 상권조사</dt>
														<dd>
															점포 후보지의 특성과 입지조건을 면밀히 분석한 후<br>투자 규모와 수익성을 검토합니다.
														</dd>
													</dl> <span class="ico_fran_step2"></span>
												</li>
												<li>
													<dl>
														<dt>Step.3 신청서접수</dt>
														<dd>
															가맹점 희망자는 개점 의사를 확인한 후 본사에<br>가맹신청서를 접수하게 됩니다.
														</dd>
													</dl> <span class="ico_fran_step3"></span>
												</li>
												<li>
													<dl>
														<dt>Step.4 가맹계약체결</dt>
														<dd>
															가맹계약을 체결함으로써 다미노피자와의<br>본격적인 파트너가 됩니다.
														</dd>
													</dl> <span class="ico_fran_step4"></span>
												</li>
												<li>
													<dl>
														<dt>Step.5 개점전 준비사항</dt>
														<dd>
															가맹점주의 점포확보, 실내 외 공사 계약, 종업원확보, 점주와<br>종업원에 대한 교육을
															준비해 드립니다.
														</dd>
													</dl> <span class="ico_fran_step5"></span>
												</li>
												<li>
													<dl>
														<dt>Step.6 점포공사실기</dt>
														<dd>
															점주는 회사의 시방서에 따라 점포 내외부 공사, 전기 및 설비공사를<br>실시한 후 표준 점포
															장비를 설치하고 집기 비품을 구입합니다.
														</dd>
													</dl> <span class="ico_fran_step6"></span>
												</li>
												<li>
													<dl>
														<dt>Step.7 개점준비</dt>
														<dd>
															Sub Franchisee 영업에 필요한 각종 인허가를 취득하고 회사는<br>자재를 점포에
															반입하여 Open을 준비합니다.
														</dd>
													</dl> <span class="ico_fran_step7"></span>
												</li>
												<li>
													<dl>
														<dt>Step.8 점포개설</dt>
														<dd>
															마케팅 홍보와 관련하여 본사의 지원 아래<br>점포를 개점합니다.
														</dd>
													</dl> <span class="ico_fran_step8"></span>
												</li>
											</ol>
										</div>
									</div>
