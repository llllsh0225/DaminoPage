				...
				<article class="quick-area">
					...
					<div class="quick-order">
						...
						<div class="quick-guide">
							<p>자주 이용하시는 제품을 더 빨리 주문할 수 있는 다미노피자의 회원전용 서비스입니다.<br>
							온라인 회원 로그인 후 아래 두가지 방법 중 하나로 퀵 오더를 설정하시고 이용하시기 바랍니다.</p>
							<div class="guide-btn">
								<div class="item">
									<i class="ico-order"></i>
										주문내역에서 선택
								...
								<div class="item">
									<i class="ico-quick2"></i>
										퀵 오더 페이지에서 설정
								</div>
								<a href="javascript:UI.layerPopUp({selId:'#pop-quick-howto'})" class="btn-detail"><i class="ico-sch"></i><span class="hidden">설정방법 및 자세히보기</span></a>
							</div>
						</div>
						<!--//퀵 오더-->
						</div>
    ...
    <div class="pop-wrap">
        ...
        <div class="pop-content">
            <div class="step-cont">
                ...
                <ol>
                    <li>
                        <p class="title-type4"><span class="number">01.</span>나의 정보 > 주문 내역에서 자주 이용하시는 주문내역의 상세보기를
                            클릭하세요.</p>
                        <figure>
                            <img src="https://cdn.dominos.co.kr/domino/pc/images/quick/quick_howto1.png" alt=""/>
                        </figure>
                    </li>
                    <li>
                        <p class="title-type4"><span class="number">02.</span>상세내역 페이지 아래의 &lsquo;퀵 오더 등록&rsquo;버튼을 누르시면 해당주문의 제품과
                            배송방법 및 배송지/매장이 저장됩니다.
                            <br>(할인은 주문하실 때 마다 자동으로 추천됩니다.)</p>
                        <figure>
                            <img src="https://cdn.dominos.co.kr/domino/pc/images/quick/quick_howto2.png" alt=""/>
                        </figure>
                    </li>
                </ol>
            </div>
            <div class="step-cont">
                ...
                <ol>
                    <li>
                        <p class="title-type4"><span class="number">01.</span>다미노 서비스 > 퀵 오더 페이지에서 &lsquo;퀵 오더 설정하기&rsquo; 버튼을
                            클릭하세요.</p>
                        <figure>
                            <img src="https://cdn.dominos.co.kr/domino/pc/images/quick/quick_howto3.png" alt=""/>
                        </figure>
                    </li>
                    <li>
                        <p class="title-type4"><span class="number">02.</span>퀵 오더 설정 페이지에서 원하는 내용으로 퀵 오더를 설정합니다.
                            <br>(할인은 주문하실 때 마다 자동으로 추천됩니다.)</p>
                        <figure>
                            <img src="https://cdn.dominos.co.kr/domino/pc/images/quick/quick_howto4.png" alt=""/>
                        </figure>
                    </li>
                </ol>
            </div>
...
<script type="text/javascript">
	_TRK_PI = "WP_15_3";	// 웹페이지의 성격 정의 - 퀵오더안내
	_TRK_CP = "더보기>다미노 서비스>퀵오더";
</script>
<!-- // LOGGER 환경변수 설정 -->
<!-- 로딩 이미지 -->
	<!-- // 로딩 이미지 -->
