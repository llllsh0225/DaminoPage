...
<!--메인에는 sub.css 호출하지않음-->
<link rel="stylesheet" type="text/css"
	href="<c:url value='/resources/css/usersub.css' />">
<!--//메인에는 sub.css 호출하지않음  -->
							...
							<div class="order-view">
								...
								<div class="order-info">
									...
									<dl>
										<dt>매장정보</dt>
										<dd>
											세종로점&nbsp;<a href="tel:02-723-3082" class="tel">02-723-3082</a>
										</dd>
									</dl>
									<dl>
										<dt>추가요청</dt>
								...
								<div class="btn-wrap">
									...
									<div class="t-r">
										...
										<a href="javascript:profileOrder('Q');" class="btn-type v4">퀵오더
											등록</a>
									</div>
								</div>
							</div>
