			...
			<div class="inner-box">
				...
				<article class="mypage-wrap mypage-grade mypage-info">
					...
					<div class="info-wrap">
                        ...
                        <div class="text-type">다미노피자를 이용해주셔서 감사합니다. 불편하셨던 점이나 불만사항을 알려주시면 적극 반영하도록 노력하겠습니다.</div>
                    </div>
					<div class="myinfo-wrap withdrawal">
                        <div class="text-type4">탈퇴 시 고객님께서 보유하셨던 온라인 쿠폰과 등급 기록이 모두 삭제되며, 한번 탈퇴한 아이디는 다시 사용 불가능합니다.</div>
                        <div class="form">
                        <form name="f" id="f" action="/member/outMemberProc" method="post">
                                ...
                                <dd>
                                    <div class="form">
                                        <div class="chk-box selected">
                                            <input type="radio" id="rdb_reason1" name="rdb_reason" value="R1" checked="checked">
                                            <label class="checkbox" for="rdb_reason1"></label>
                                            <label for="rdb_reason1">관리자 답변 불만</label>
                                        </div>
                                        <div class="chk-box">
                                            <input type="radio" id="rdb_reason2" name="rdb_reason" value="R2">
                                            <label class="checkbox" for="rdb_reason2"></label>
                                            <label for="rdb_reason2">회사 서비스에 대한 불만</label>
                                        </div>
                                        <div class="chk-box">
                                            <input type="radio" id="rdb_reason3" name="rdb_reason" value="R3">
                                            <label class="checkbox" for="rdb_reason3"></label>
                                            <label for="rdb_reason3">시스템 성능 불만</label>
                                        </div>
                                        <div class="chk-box">
                                            <input type="radio" id="rdb_reason4" name="rdb_reason" value="R4">
                                            <label class="checkbox" for="rdb_reason4"></label>
                                            <label for="rdb_reason4">사이트 정보 미흡</label>
                                        </div>
                                    </div>
                                    <div class="form">
                                        <div class="chk-box">
                                            <input type="radio" id="rdb_reason5" name="rdb_reason" value="R5">
                                            <label class="checkbox" for="rdb_reason5"></label>
                                            <label for="rdb_reason5">광고 메일 수신</label>
                                        </div>
                                        <div class="chk-box">
                                            <input type="radio" id="rdb_reason6" name="rdb_reason" value="R6">
                                            <label class="checkbox" for="rdb_reason6"></label>
                                            <label for="rdb_reason6">개인정보 보호</label>
                                        </div>
                                        <div class="chk-box">
                                            <input type="radio" id="rdb_reason7" name="rdb_reason" value="R7">
                                            <label class="checkbox" for="rdb_reason7"></label>
                                            <label for="rdb_reason7">기타</label>
                                        </div>
                                    </div>
                                </dd>
                            </dl>
                          <dl>
                                ...
                                <dd>
                                    <div class="form info-form">
                                        <textarea cols="30" rows="10" id="breakout_content" maxlength="500" placeholder="기타 불편사항 및 다미노피자에 바라는 고객님의 소중한 의견을 적어주세요.(500자 이내)"></textarea>
                                    </div>
                                </dd>
                            </dl>
                        </form>
                        ...
                        <div class="btn-wrap">
                            <a href="javascript:outMemberCancel();" class="btn-type v4">탈퇴 취소</a>
                            <a href="javascript:outMemberProc();" class="btn-type v6">탈퇴하기</a>
                        </div>
                    </div>
				</article>
			</div>
