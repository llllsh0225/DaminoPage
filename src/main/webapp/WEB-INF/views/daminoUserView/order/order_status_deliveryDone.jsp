...
<div id="container">
			...
			<div class="inner-box">
				...
				<article class="mypage-wrap mypage-grade">
					...
					<div class="info-wrap">
						...
						<a href="javascript:UI.layerPopUp({selId:'#pop-order-info'});" class="btn-type4-brd4">이용안내</a>
					</div>
											...
											<div class="order-center">
												...
												<div class="info od-box">
													<a href="javascript:goView('20200717863942990011');">
														<div class="menu">
															베스트 콰트로 슈퍼시드 함유 도우 외 1건&nbsp;
															31,520원
														</div>
													</a>
												</div>
												<div class="btn-detail od-box">
													<a href="javascript:goView('20200717863942990011');" class="detail">상세보기</a>
												</div>
											</div>
	...
	<div class="map-inner">
		<dl>
			<dt>
								<span class="thumb" style="background-image: url(https://cdn.dominos.co.kr/admin/upload/webdlvr/20200407_vJGM5c9V.JPG)">사진</span>
							</dt>
							<dd>
								<p>
									매장명 <strong>세종로점</strong>
									배달자 <strong>이은우</strong>
								</p>
								<div class="text-type">
									오븐에서 갓 구운 피자가 배달 중입니다.<br/>
									*도착 예상 시간은 도로 제한속도, 신호 등 안전 운행 원칙으로 측정되며, 제공시간은 교통상황에 따라 달라질 수 있습니다.
								</div>
							</dd>
						</dl>
		<div class="map-area">
		...
		<a href="#">지도 숨기기 <i class="ico-arrow"></i></a>
									...
									<li>
											<div class="order-top">
												...
												<span class="date">
													<span class="tit">주문일시</span>
													2020-07-17 18:10</span>
												<span class="num">
													<span class="tit">주문번호</span>
													20200717863942990010</span>
												</div>
											<div class="order-center">
												<div class="state od-box">
													<strong>주문취소</strong>
												...
												<div class="btn-detail od-box">
													<a href="javascript:goView('20200717863942990010');" class="detail">상세보기</a>
												</div>
											</div>
											</li>
									<li>
											<div class="order-top">
												...
												<span class="date">
													<span class="tit">주문일시</span>
													2019-10-30 11:30</span>
												<span class="num">
													<span class="tit">주문번호</span>
													20191030863769990002</span>
												<div class="btn-wrap">
														 <a href="javascript:myOrderReOrder('R','20191030863769990002');">+ 재주문 하기</a>
														 <a href="javascript:myOrderReOrder('Q','20191030863769990002');">+ 퀵오더 등록</a>
														 </div>
												</div>
											<div class="order-center">
												<div class="state od-box">
												...
												<div class="btn-detail od-box">
													<a href="javascript:goView('20191030863769990002');" class="detail">상세보기</a>
												</div>
											</div>
											</li>
									<li>
											<div class="order-top">
												...
												<span class="date">
													<span class="tit">주문일시</span>
													2019-09-28 20:46</span>
												<span class="num">
													<span class="tit">주문번호</span>
													20190928863769990047</span>
												<div class="btn-wrap">
														 <a href="javascript:myOrderReOrder('R','20190928863769990047');">+ 재주문 하기</a>
														 <a href="javascript:myOrderReOrder('Q','20190928863769990047');">+ 퀵오더 등록</a>
														 </div>
												</div>
											<div class="order-center">
												<div class="state od-box">
												...
												<div class="btn-detail od-box">
													<a href="javascript:goView('20190928863769990047');" class="detail">상세보기</a>
												</div>
											</div>
											</li>
									</ul>
								<div class="pager-wrap">
									<div class="pager-inner">
										<a href='javascript:;' class='pager-first'><span class="hidden">첫페이지</span></a><a href='javascript:;' class='pager-prev'><span class="hidden">이전페이지</span></a><strong class="pager-item active">1</strong><a href='javascript:;' class='pager-next' onclick='javascript:paging(1, 1); return false;'><span class="hidden">다음페이지</span></a><a href='javascript:;' class='pager-last'><span class="hidden">마지막페이지</span></a></div>
								</div>
							</div>
				</article>
			</div>
		...
		<div class="pop-content">
			<div class="pop-text">
				...
				<ul class="list-text-v2">
					<li>매장(1577-3082) 또는 콜센터(080-860-3082) / 다른 이름으로 주 문하신 내역은 온라인 주문내역에 표시되지 않습니다.</li>
					<li>온라인 상으로 주문한 최초의 이력만 확인하실 수 있으며, 전화를 통해 변경하신 사항은 반영되지 않습니다. </li>
					<li>주문번호를 클릭하시면 상세정보(주문번호/배달장소/주문내역 등) 를 확인하실 수 있습니다. </li>
					<li>메뉴 변경이나 주문취소를 원하실 경우, 매장에 주문번호를 알려 주셔야 합니다. (온라인으로 주문취소는 불가합니다.) </li>
					<li>결제방법을 수정하실 경우에는 해당 매장으로 직접 연락하셔야 하며, 배달 중에는 변경 불가합니다. </li>
					<li>영수증 출력을 원하시는 고객님은 주문상세 페이지의 &lsquo;영수증 출 력&rsquo;을 클릭하시면, 해당 주문의 영수증을 출력할 수 있습니다. </li>
				</ul>
			</div>
