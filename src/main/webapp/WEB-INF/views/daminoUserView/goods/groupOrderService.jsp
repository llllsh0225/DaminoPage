				...
				<div class="sub-type quick">
					<div class="inner-box">
						<div class="page-title-wrap">
							<h2 class="page-title">도미노 서비스</h2>
							<div class="depth-area">
								<ol>
									<li><a href="../main.html">홈</a></li>
									<li><a href="../event/mania.html">도미노 서비스</a></li>
						...
						<article class="quick-area">
							<div class="menu-nav-wrap">
								<div class="menu-nav">
									<ul>
										...
										<li class="active"><a href="groupOrderService.html">단체주문
												서비스</a></li>
									</ul>
								</div>
							</div>
							<div class="group-order">
								<div class="group-text">
									<p>
										다양한 행사, 모임, 파티, 이벤트 등에서 소중한 사람들과 함께 누리는 즐거움을 위해<br> 맛있는
										도미노 피자를 다량으로 주문하고 싶으시면,
									</p>
									<i class="ico-delivery"></i>
									<p class="v2">
										주문부터 결제까지 간편한<br> <em>도미노피자 단체주문 서비스를 이용해보세요.</em> <span
											class="tel">02-555-3874</span>
									</p>
								</div>
								<div class="step-wrap">
									<div class="title-wrap-center">
										<h3 class="title-type">도미노피자 단체주문 혜택</h3>
									</div>
									<ol>
										<li>01. <em>한번의 결제로 여러곳의 배달지로</em> 전국 도미노피자 어느곳에서도 배달가능
										</li>
