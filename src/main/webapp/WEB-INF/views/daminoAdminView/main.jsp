...
<body class="sb-nav-fixed">
	...
	<script src="../../resources/assets/admin/chart-area-demo.js"></script>
	<script src="../../resources/assets/admin/chart-bar-demo.js"></script>
	<script src="../../resources/assets/admin/chart-area-demo_month.js"></script>
	<script
	...
	<script
		...
		crossorigin="anonymous"></script>
	<script src="../../resources/assets/admin/datatables-demo.js"></script>
