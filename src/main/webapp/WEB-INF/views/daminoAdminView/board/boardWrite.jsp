...
<body class="sb-nav-fixed">
					...
					<div class="nav">
						...
						<div class="collapse" id="customerPage" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link collapsed" href="member.html"> 회원관리 </a> <a class="nav-link collapsed" href="controlMarket.html"> 점포승인 </a>
							</nav>
						</div>
						...
						<div class="collapse" id="storePage" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link collapsed" href="enroll.html"> 매장등록 </a> <a class="nav-link collapsed" href="control.html"> 매장조회 </a>
							</nav>
						</div>
						...
						<div class="collapse" id="ordersalesPage" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link collapsed" href="order-count.html"> 주문조회 </a> <a class="nav-link collapse" href="order-stats.html"> 매출현황 </a>
							</nav>
						</div>
						...
						<div class="collapse" id="boardPage" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link collapsed" href="noticeBoardView.html"> 게시판리스트 </a> <a class="nav-link collapse" href="boardList.html"> 게시글관리 </a>
							</nav>
						</div>
						...
						<div class="collapse" id="menuPage" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
								<a class="nav-link collapsed" href="get-menus.html"> 메뉴조회 </a> <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#insertMenuPage" aria-expanded="false"
								...
								<div class="collapse" id="insertMenuPage" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
									<nav class="sb-sidenav-menu-nested nav">
										<a class="nav-link" href="insert-menu-pizza.html">피자</a> <a class="nav-link" href="insert-menu-side.html">사이드디시</a> <a class="nav-link" href="insert-menu-drink.html">음료&기타</a> <a
						...
						<div class="collapse" id="sitePage" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="site-qna-list.html">Q&A</a> <a class="nav-link" href="bannerBoardView.html">배너관리</a> <a class="nav-link" href="site-term-list.html">약관관리</a>
							</nav>
						</div>
					</div>
				</div>
								...
								<table class="table table-bordered" id="dataTable" width="100%" height="100%" cellspacing="0">
									...
									<tr>
										...
										<td style="height: 600px">
											<textarea name="content" rows="30" cols="14" style="width: 80%" style="height: 80%">
											</textarea>
										</td>
									</tr>
								</table>
								<b>첨부파일 : </b><input type="text" size="50" /> 
	...
	<script type="text/javascript" src="<c:url value='https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js'/>" crossorigin="anonymous"></script>
