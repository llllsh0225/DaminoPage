 ...
 * com.damino.web.admin.banner.BannerService; import
 * com.damino.web.admin.banner.BannerVO;
 * 
 * @Service("bannerService") public class BannerServiceImpl implements
 * BannerService {
 * 
 ...
 * System.out.println("[bannerserviceimpl] getbannerList()..."); return
 * bannerDAO.getBannerList(); }
 * 
 * @Override public BannerVO getBanner(BannerVO vo) {
 * System.out.println("[bannerserviceimpl] getBanner..."); return
 * bannerDAO.getBanner(vo); }
 * 
